...
class LoginViewConroller: UIViewController, UITextFieldDelegate, ValidationDelegate, GIDSignInUIDelegate {
    ...
    /**
        This method is used to validate an email and password.
    */
    ...
    /**
        This method is used to validate a single field registered to Validator.
        If validation is unsuccessful,field gets removed from view controller.
    */
